...
- **LaTeX Markdown Conflict Prevention:** Escaped chiral asterisks (`*`) in chemistry formulas using `\\ast` to prevent markdown parsers from treating them as italic indicators and breaking KaTeX expression rendering.
