...
- **Granular Lesson Tree & Syllabus Alignment:** Maps 56 unique lessons for CIE tracks and 22 lessons (across 6 units) for Edexcel, aligned 100% with the official Pearson Edexcel IAL syllabus (Topics 11 to 20). Fully completed interactive curricula for:
  ...
  - **Edexcel Unit 6 (WCH16):** Lesson 1 covering A2 Practical Skills and Laboratory Techniques.
    ...
    - Added **25 new comprehensive exam questions for Pearson Edexcel IAL Unit 1 (WCH11) May/June 2026** (including full **Section A: 20 MCQs** and **Section B: 5 Structured Theory Questions** covering Topics 1-5: Avogadro calculations, molar gas density, hydrated cobalt(II) chloride & magnesium sulfate decomposition, heating to constant mass, atom economy, zirconium isotopes, successive ionisation energy trends, 3d degenerate orbitals, spin-pair repulsion, 3s shielding vs 3p energy in Al, VSEPR PCl₃ & ICl₂⁻ geometries, PCl₅ dipole vector cancellation, Fajans' rules covalent character, graphite conductivity, IUPAC branched alkanes, free-radical initiation/propagation/termination yielding trace butane, catalytic cracking with zeolite, tertiary carbocation stability in electrophilic addition to 2-methylbut-2-ene, E/Z stereoisomerism CIP rules, KMnO₄ oxidation to diols, acrylonitrile addition polymerisation, and pV=nRT combustion analysis) with full official point-by-point marking schemes, keyword rubrics, and examiner tips.
    - Added **25 new comprehensive exam questions for Pearson Edexcel IAL Unit 2 (WCH12) May/June 2026** (including full **Section A: 20 MCQs** and **Section B: 5 Structured Theory Questions** covering Topics 6-10: Hess's Law cycles and enthalpy of combustion of methanol, calorimetry heat loss errors, Haber process bond enthalpies, H₂O vs HF hydrogen bonding capacity, branching in pentane isomers and London dispersion forces, Cl₂ disproportionation with cold dilute alkali, Group 2 nitrate thermal stability and polarising power trends, flame test emission colors (Sr²⁺ crimson), halide redox reactions with conc. H₂SO₄, halogen displacement in organic hexane layers, Maxwell-Boltzmann catalyst activation energy shift, collision theory vs concentration, Le Chatelier and temperature effect on endothermic $K_c$, $K_c$ units derivation, halogenoalkane hydrolysis rate vs C-Hal bond enthalpy, tertiary halogenoalkane $S_N1$ mechanism, butan-2-ol acid-catalyzed elimination to but-2-ene, secondary alcohol oxidation with acidified dichromate, IR alcohol O-H stretch identification, and propan-2-one mass spec base peak $[CH_3CO]^+$ at $m/z = 43$; alongside multi-part structured questions for CuSO₄ hydration Hess's cycles, Mg(NO₃)₂ thermal decomposition, halogenoalkane $S_N2$ transition state Walden inversion stereochemistry, ethanol distillation vs reflux, and combined IR/MS structural deduction of $C_3H_8O$) with official keyword scoring rubrics and examiner guidance.
    - Added **15 authentic practical exam questions for Pearson Edexcel IAL Unit 3 (WCH13/01) Practical Skills in Chemistry I May/June 2026** covering Core Practicals 1 to 8: molar volume of hydrogen gas with gas syringe and procedural errors, preparing $250.0\text{ cm}^3$ of standard $\text{Na}_2\text{CO}_3$ solution by weighing by difference with volumetric flask technique, acid-base titration of standard $\text{Na}_2\text{CO}_3$ with burette rinsing protocols, methyl orange end-point and burette double percentage uncertainty ($\pm 0.41\%$), cooling curve extrapolation method for enthalpy of neutralisation ($q = mc\Delta T$, $\Delta H = -56.8\text{ kJ mol}^{-1}$), spirit burner combustion calorimetry systematic errors and evaporation mitigation, hydrolysis rates of primary halogenoalkanes ($C-I > C-Br > C-Cl$ bond enthalpy vs polarity), tertiary vs primary haloalkane hydrolysis ($S_N1$ carbocation stability vs $S_N2$), ethanal partial oxidation distillation apparatus setup with ice-water bath, ethanoic acid reflux setup with anti-bumping granules and pressure safety, chlorination and purification of 2-methylpropan-2-ol using separating funnel venting and anhydrous drying agents, inorganic qualitative analysis for $\text{Ca}^{2+}$ flame test and $\text{SO}_4^{2-}$ with $\text{BaCl}_2$, halide identification sequence with aqueous ammonia and concentrated $\text{H}_2\text{SO}_4$ redox, ammonium ion test with $\text{NaOH}$ and damp red litmus, distinguishing four organic functional groups, and calcium carbonate back titration with purity calculation ($66.7\%$), all featuring point-by-point marking rubrics and examiner tips.
    - Added **25 new comprehensive exam questions for Pearson Edexcel IAL Unit 4 (WCH14/01) Rates, Equilibria and Further Organic Chemistry May/June 2026** (including full **Section A: 20 MCQs** and **Section B: 5 Structured Theory Questions** covering Topics 11-15: rate equations and factor changes, rate constant units derivation ($\text{dm}^6\text{ mol}^{-2}\text{ s}^{-1}$), Arrhenius gradient plots ($E_a = +99.7\text{ kJ mol}^{-1}$), pre-equilibrium multi-step reaction mechanisms, standard system entropy changes ($\Delta S^\theta_{\text{system}}$ in Haber process), surroundings entropy ($\Delta S^\theta_{\text{surroundings}} = -\Delta H / T$), minimum temperature for $\text{CaCO}_3$ feasibility ($1106\text{ K}$), Born-Haber cycle covalent polarization in $\text{AgI}$, entropy-driven dissolution of $\text{NaCl}$, $K_p$ partial pressure calculations, pressure invariance and temperature dependence of $K_p$, barium hydroxide strong base pH ($12.70$), ethanoic acid weak acid pH ($2.79$), buffer solution pH ($4.57$) and buffer resistance calculations, indicator selection by titration curve vertical range, planar carbonyl addition yielding optically inactive racemic mixtures, Tollens' silver mirror test for propanal, positive iodoform test for methyl ketones ($\text{CHI}_3$ yellow precipitate), and acyl chloride vs ester hydrolysis kinetics; alongside Section B multi-part problems for NO/H₂ initial rates tables and rate-determining steps, $\text{MgCl}_2$ Born-Haber cycle and lattice energy ($-2526\text{ kJ mol}^{-1}$), $\text{SO}_2/\text{O}_2/\text{SO}_3$ $K_p$ derivation, ethanoic acid buffer capacity with $\text{NaOH}$ addition, and butanal nucleophilic addition with $\text{HCN}$ to 2-hydroxypentanenitrile and hydrolysis to 2-hydroxypentanoic acid) with full official point-by-point marking schemes, keyword rubrics, and examiner tips.
