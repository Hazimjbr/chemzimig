...
- **Granular Lesson Tree:** Maps 56 unique lessons for CIE tracks and 22 lessons (across 6 units) for Edexcel. Fully completed interactive curricula for Edexcel Unit 1 Topic 1, and now completed Unit 4 Topics 12 (Kinetics & Equilibria II), 13 (Entropy & Energetics II), 14 (Chemical Equilibria II), and 15 (Acid-Base Equilibria) with slide-based parts (including calculus definitions of rates, experimental rate justifications, homogeneous/heterogeneous catalysis, autocatalysis dynamics), quantitative practice calculations, and custom unit-tested quizzes.
