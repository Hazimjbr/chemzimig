...
- **Granular Lesson Tree & Syllabus Alignment:** Maps 56 unique lessons for CIE tracks and 21 lessons (across 6 units) for Edexcel, aligned 100% with the official Pearson Edexcel IAL syllabus (Topics 11 to 20). Fully completed interactive curricula for:
  ...
  - **Edexcel Unit 5 Topic 20 / Unit 4 Topic 15 (Modern Analytical Techniques II: Chromatography & Spectroscopy):** Modern Analytical Techniques II (TLC, GC-MS, HRMS, NMR principles, 13C NMR, Low & High-Res 1H NMR splitting) with 8 interactive theory parts, 5 high-fidelity inline visualizer SVGs (`chromatographySvg`, `chromatogramRfDiagramSvg`, `hrmsSpectrumSvg`, `instrumentalChromatographySvg`, `nmrPrinciplesSvg`), and **18 sequentially numbered worked examples** with step-by-step solutions covering TLC/paper Rf calculations, HPLC vs column mechanics, GC retention variables, HRMS mass calculations & spectrum decoding, combined GC-MS/HPLC-MS applications, 13C NMR peak counts, low-res 1H NMR isomer differentiation (butanal vs butanone), high-res 1H NMR n+1 splitting (methyl propanoate), structural deduction for C4H8O2 isomers (ethyl ethanoate vs methylpropanoic acid), and symmetrical proton splitting rules (1,2-dichloroethane vs 1,1-dichloroethane).
