...
- **Granular Lesson Tree & Syllabus Alignment:** Maps 56 unique lessons for CIE tracks and 22 lessons (across 6 units) for Edexcel, aligned 100% with the official Pearson Edexcel IAL syllabus (Topics 11 to 20). Fully completed interactive curricula for:
  - **Cambridge IGCSE Chemistry (CIE IGCSE 0620) Question Bank Overhaul:** Replaced all placeholder dummy questions with real, high-quality, syllabus-aligned exam-style multiple-choice questions across Units 2 to 12 (specifically Units 2, 3, 4, 5, 6, 7, 8, 9, 11, and 12). Created complete Level 1 (Retrieve), Level 2 (Apply), and Level 3 (Analyze) question sets for these units, providing comprehensive assessment capabilities across key topics (atoms & bonding, stoichiometry, kinetics, energetics, redox, acids & bases, organic chemistry, etc.).
...
- **Gaming & Fantasy 3D Preset Avatars (Expanded Collection):** Added 13 new high-quality 3D gaming preset avatars (7 Roblox 3D avatars including Roblox Chemist, Ninja, Cyber, Flame Lord, Dragon Knight, Valkyrie, and Quantum Astronaut; 4 Ice Mage fantasy avatars including Frost Sorceress, Frost Archmage, Ice Empress, and Frost Knight; and 2 Viking warriors with authentic weapons — Viking Berserker with battle axe and Viking Shieldmaiden with sword & shield), all fully integrated into the student profile selection modal (`app/dashboard/profile/page.tsx`).
