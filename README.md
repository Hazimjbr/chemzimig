...
- **Granular Lesson Tree & Syllabus Alignment:** Maps 56 unique lessons for CIE tracks and 21 lessons (across 6 units) for Edexcel, aligned 100% with the official Pearson Edexcel IAL syllabus (Topics 11 to 20). Fully completed interactive curricula for:
  ...
  - **Edexcel Unit 5 Topic 20 / Unit 4 Topic 15 (Modern Analytical Techniques II: Chromatography & Spectroscopy):** Modern Analytical Techniques II (TLC, GC-MS, HRMS, NMR principles, 13C NMR, Low & High-Res 1H NMR splitting) with 8 interactive theory parts, 5 high-fidelity inline visualizer SVGs (`chromatographySvg`, `chromatogramRfDiagramSvg`, `hrmsSpectrumSvg`, `instrumentalChromatographySvg`, `nmrPrinciplesSvg`), and 13 sequentially numbered worked examples with step-by-step solutions interleaved directly after their respective theoretical concepts.
