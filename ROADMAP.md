...
**إنجازات هذا الجلسة (2026-07-21):**
1. استكمال وتطوير محتوى **Topic 14: Chemical Equilibria II** لمنهج Edexcel A-Level بالكامل (6 أجزاء تفاعلية كاملة: Kc, Kp, Q vs K, Le Chatelier, Temperature & Equilibria, Entropy & Kp) مع تصحيح جميع مشاكل عرض الرموز الكيميائية والرياضية (KaTeX + unicode subscripts).
2. استكمال وتطوير محتوى **Topic 15: Acid-Base Equilibria** لمنهج Edexcel A-Level بالكامل (5 أجزاء تفاعلية: Brønsted-Lowry & pH, Weak Acids/Ka/pKa, Titrations & Indicators, Buffer Solutions, Ka from pH Curves) مع جميع المعادلات والجداول والأمثلة النموذجية.
3. تكامل **17 سؤال امتحاني** جديد (Topic 14) في قاعدة بيانات الأسئلة، مع وسم كامل بالوحدة والدرس والمستوى.
4. تكامل **17 سؤال امتحاني** جديد (Topic 15) في قاعدة بيانات الأسئلة، شاملة أسئلة حساب الـ pH، الـ Ka، الـ pKa، المحاليل المنظمة، والمعايرة.
5. إصلاح كامل لمشاكل عرض الرموز في Template Literals (double-escape backslashes، unicode subscripts بدلاً من LaTeX underscores).
6. تحديث `README.md` و `ROADMAP.md` ليعكسا آخر الإنجازات.
