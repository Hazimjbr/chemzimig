...
1. إصلاح انهيار صفحة المناهج (Syllabus) لحسابات الطلاب عبر ربط معرفات المناهج ذات اللاحقة التاريخية `-20260106` مع المسارات الافتراضية للطلاب.
2. حماية مكون `CurriculumView` من الانهيار عند استقبال قوائم مناهج فارغة بإضافة واجهة تنبيهية آمنة (Empty-State UI).
3. إعادة تصميم وتعديل مسميات خيارات الفلترة الذكية للأسئلة في مولد الامتحانات لزيادة وضوح تجربة المستخدم.
4. توثيق المخططات البرمجية والواجهات الأساسية للطلاب والامتحانات والدروس في ملف القواعد `AGENTS.md` لتوحيد السياق البرمجي).* - **م. حازم جبر**
