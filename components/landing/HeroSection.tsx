        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-gold-500/20 mb-8 animate-fade-in-up">
            ...
            <span className="text-xs font-medium text-gold-300">
              Cambridge • Edexcel • AP • IB • EST & More
            </span>
          </div>
          ...
          >
            {isAuthenticated ? (
              ...
              <button
                ...
                className="group relative px-8 py-4 rounded-xl bg-gradient-to-r from-gold-600 to-gold-500 text-navy-950 font-semibold text-base shadow-xl shadow-gold-500/25 hover:shadow-gold-500/40 hover:scale-105 transition-all duration-300 flex items-center gap-2 cursor-pointer"
                id="hero-cta-primary"
              >
          ...
          >
            {[
              { value: "AI-Powered", label: "Smart Hints" },
              { value: "Real-time", label: "Progress Tracking" },
              { value: "Interactive", label: "Practice Quizzes" },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-white font-[family-name:var(--font-space-grotesk)]">
                  {stat.value}
                </div>
